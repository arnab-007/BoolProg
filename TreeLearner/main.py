...
def get_init_state(progname):
    with open(os.path.join(PARENT_PATH, "Program_state_sampler/Sampler_results", f"init_{progname}_1.json"), "r") as f:
...
#DistEstimate_trigger_path = os.path.join(PARENT_PATH, "DistEstimate/", "DistEstimate_trigger.sh")
#Validifier_trigger_path = os.path.join(PARENT_PATH, "Validifier/", "Validifier_trigger.sh")
...
valid_results_directory = os.path.join(PATH, "Validifier_results")
...
print(file_number)
validifier_path = os.path.join(PATH, "Validifier_results", f"exp_{progname}_{file_number}.json")
...
dist_results_directory = os.path.join(PATH, "DistEstimate_results")
...
with open(os.path.join(PATH, "DistEstimate_results", f"exp_{progname}_{file_number}.json"), "r") as file:
